            ...
            COMBAT: {
                ...
                skills: {
                    ...
                    whirlwind: {
                        ...
                        maxLevel: 5,
                        prerequisite: ['cleave'],
                        energyCost: [38, 36, 33, 31, 27],
                        cooldown: 3,
                        damageMultiplier: [1.05, 1.2, 1.34, 1.48, 1.63],
                        damageType: 'PHYSICAL',
                        targeting: 'AOE_LARGE',
                        effects: { bleed: { chance: [37, 47, 56, 65, 74], duration: 3, value: [15, 18, 21, 24, 28] } },
                    ...
                    execute: {
                        ...
                        energyCost: [56, 51, 45],
                        cooldown: 4,
                        damageMultiplier: [2.35, 2.82, 3.29],
                        damageType: 'PHYSICAL',
                        targeting: 'SINGLE',
            ...
            ASSASSINATION: {
                ...
                skills: {
                    ...
                    blade_flurry: {
                        ...
                        energyCost: [27, 25, 23, 21, 19],
                        cooldown: 3,
                        damageMultiplier: [0.86, 0.96, 1.05, 1.15, 1.25],
                        damageType: 'PHYSICAL',
                        targeting: 'SINGLE',
                        multiHit: 4,
                        effects: { bleed: { chance: [56, 60, 65, 70, 74], duration: 3, value: [12, 14, 16, 18, 20] } },
                    ...
                    assassinate: {
                        ...
                        energyCost: [71, 65, 59],
                        cooldown: 4,
                        damageMultiplier: [4.14, 4.6, 5.06],
                        damageType: 'TRUE',
                        targeting: 'SINGLE',
            ...
            ARCANE: {
                ...
                skills: {
                    ...
                    blizzard: {
                        ...
                        maxLevel: 5,
                        prerequisite: ['frost_bolt'],
                        energyCost: [47, 44, 41, 37, 35],
                        cooldown: 3,
                        damageMultiplier: [1.85, 2.04, 2.22, 2.41, 2.78], // Buffed from 1.4-2.0
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: { freeze: { chance: [53, 57, 62, 66, 79], duration: 1 } },
                    ...
                    meteor: {
                        ...
                        energyCost: [79, 73, 68],
                        cooldown: 4,
                        damageMultiplier: [5.18, 6.12, 7.53], // Massive Ultimate Buff
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: {
                            burn: { chance: [81, 86, 90], duration: 4, value: [40, 50, 75] },
                            stun: { chance: [45, 54, 68], duration: 1 }
                        },
                    ...
                    gravity_well: {
                        ...
                        maxLevel: 5,
                        prerequisite: ['blizzard'],
                        energyCost: [55, 50, 46, 41, 38],
                        cooldown: 3,
                        damageMultiplier: [1.72, 1.92, 2.11, 2.3, 2.49],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: { 
                            slow: { value: [40, 50, 60, 70, 80], duration: 2 },
                            stun: { chance: [19, 23, 28, 33, 37], duration: 1 }
                        },
            ...
            RAGE: {
                ...
                skills: {
                    ...
                    rampage: {
                        ...
                        energyCost: [27, 26, 24, 22, 20],
                        cooldown: 3,
                        damageMultiplier: [1.34, 1.48, 1.63, 1.77, 1.92],
                        damageType: 'PHYSICAL',
                        targeting: 'RANDOM',
                        multiHit: 4,
                    ...
                    reckless_assault: {
                        ...
                        energyCost: [41, 38, 35, 33, 29],
                        cooldown: 3,
                        damageMultiplier: [2.78, 3.06, 3.33, 3.61, 3.89],
                        damageType: 'PHYSICAL',
                        targeting: 'SINGLE',
                        effects: {
                            guaranteedCrit: true,
                    ...
                    dimensional_slash: {
                        ...
                        maxLevel: 5,
                        prerequisite: ['warcry'],
                        energyCost: [47, 44, 42, 40, 35],
                        cooldown: 3,
                        damageMultiplier: [3.24, 3.52, 3.8, 4.08, 4.63],
                        damageType: 'TRUE',
                        targeting: 'SINGLE',
                        effects: {
                    ...
                    last_stand: {
                        ...
                        energyCost: [56, 51, 45],
                        cooldown: 4,
                        damageMultiplier: [4.7, 5.18, 5.65],
                        damageType: 'TRUE',
                        targeting: 'AOE_LARGE',
            ...
            HOLY: {
                ...
                skills: {
                    ...
                    divine_judgment: {
                        ...
                        energyCost: [77, 71, 65],
                        cooldown: 4,
                        damageMultiplier: [3.22, 3.68, 4.14],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: { stun: { chance: [61, 70, 78], duration: 2 } },
            ...
            UNDEATH: {
                ...
                skills: {
                    ...
                    plague: {
                        ...
                        energyCost: [47, 43, 40, 36, 33],
                        cooldown: 3,
                        damageMultiplier: [1.11, 1.25, 1.39, 1.53, 1.67],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: {
            ...
            TIME: {
                ...
                skills: {
                    ...
                    temporal_rift: {
                        ...
                        energyCost: [38, 36, 34, 32, 29],
                        cooldown: 3,
                        damageMultiplier: [2.3, 2.49, 2.68, 2.87, 3.06],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_SMALL',
                        effects: {
                            stun: { chance: [47, 51, 56, 60, 65], duration: 1 },
            ...
            GOLD: {
                ...
                skills: {
                    ...
                    bribe: {
                        ...
                        requiredLevel: 1,
                        maxLevel: 5,
                        energyCost: [16, 15, 14, 13, 11],
                        goldCost: [300, 250, 200, 150, 100],
                        cooldown: 3,
                        targeting: 'SINGLE',
                        effects: {
                            charm: { chance: [56, 60, 65, 70, 74], duration: 2 },
                            pacify: { chance: [74, 79, 84, 88, 93], duration: 3 }
                        },
                    ...
                    money_rain: {
                        ...
                        energyCost: [45, 43, 40],
                        cooldown: 4,
                        damageMultiplier: [3.29, 3.76, 4.23],
                        damageType: 'TRUE',
                        targeting: 'AOE_LARGE',
                        effects: { stun: { chance: [63, 72, 81], duration: 2 } },
            ...
            DIVINE: {
                ...
                skills: {
                    ...
                    divine_wrath: {
                        ...
                        energyCost: [68, 62, 56],
                        cooldown: 4,
                        damageMultiplier: [3.01, 3.39, 3.76],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: { stun: { chance: [54, 63, 72], duration: 1 } },
            ...
            SHADOW: {
                ...
                skills: {
                    ...
                    final_eclipse: {
                        ...
                        energyCost: [80, 74, 68],
                        cooldown: 4,
                        damageMultiplier: [4.51, 4.96, 5.41],
                        damageType: 'TRUE',
                        targeting: 'AOE_LARGE',
            ...
            SLAYER: {
                ...
                skills: {
                    ...
                    wing_clipper: {
                        ...
                        requiredLevel: 3,
                        maxLevel: 5,
                        energyCost: [27, 26, 25, 24, 22],
                        cooldown: 3,
                        damageMultiplier: [1.15, 1.25, 1.34, 1.44, 1.53],
                        damageType: 'PHYSICAL',
                        targeting: 'SINGLE',
                        effects: [
                            { type: 'stun', chance: [37, 47, 56, 65, 74], duration: 1 }
                        ],
                    ...
                    tail_cleaver: {
                        ...
                        energyCost: [38, 36, 34, 32, 29],
                        cooldown: 3,
                        damageMultiplier: [1.44, 1.63, 1.82, 2.01, 2.2],
                        damageType: 'PHYSICAL',
                        targeting: 'AOE',
                    ...
                    dragonfall: {
                        ...
                        energyCost: [86, 80, 74],
                        cooldown: 4,
                        damageMultiplier: [5.41, 5.86, 6.31],
                        damageType: 'TRUE',
                        targeting: 'SINGLE',
            ...
            ELEMENTS: {
                ...
                skills: {
                    ...
                    elemental_cataclysm: {
                        ...
                        energyCost: [92, 86, 80],
                        cooldown: 4,
                        damageMultiplier: [4.06, 4.51, 4.96],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
            ...
            COMMAND: {
                ...
                skills: {
                    ...
                    total_war: {
                        ...
                        isUltimate: true,
                        isAscended: true,
                        energyCost: [113, 102, 90],
                        cooldown: 4,
                        damageMultiplier: [6.59, 7.53, 8.47],
                        damageType: 'TRUE',
                        targeting: 'ALL_ENEMIES',
            ...
            DESTRUCTION: {
                ...
                skills: {
                    ...
                    hellfire_blast: {
                        ...
                        energyCost: [38, 36, 34, 32, 29],
                        cooldown: 3,
                        damageMultiplier: [3.35, 3.64, 3.93, 4.21, 4.6],
                        damageType: 'MAGICAL',
                        targeting: 'AOE',
                        effects: {
                    ...
                    blood_siphon: {
                        ...
                        energyCost: [35, 33, 30, 28, 26],
                        cooldown: 3,
                        damageMultiplier: [2.32, 2.59, 2.87, 3.15, 3.52],
                        damageType: 'PHYSICAL',
                        targeting: 'SINGLE',
                        effects: {
                    ...
                    crucible: {
                        ...
                        requiredLevel: 40,
                        maxLevel: 3,
                        energyCost: [123, 113, 102],
                        cooldown: 4,
                        damageMultiplier: [9.01, 10.82, 13.52],
                        damageType: 'TRUE',
                        targeting: 'ALL_ENEMIES',
            ...
            ASCENSION: {
                ...
                skills: {
                    ...
                    elemental_nova: {
                        ...
                        requiredLevel: 36,
                        maxLevel: 5,
                        energyCost: [44, 41, 39, 37, 35],
                        cooldown: 3,
                        damageMultiplier: [3.35, 3.83, 4.31, 4.79, 5.75],
                        damageType: 'MAGICAL',
                        targeting: 'AOE',
                    ...
                    universal_cataclysm: {
                        ...
                        cooldown: 4,
                        damageMultiplier: [4.25, 5.52, 6.8], // was [15.0, 20.0, 30.0] — nerfed AOE ult
                        damageType: 'MAGICAL',
                        targeting: 'ALL_ENEMIES',
            ...
            NATURE: {
                ...
                skills: {
                    ...
                    natures_fury: {
                        ...
                        energyCost: [77, 71, 65],
                        cooldown: 4,
                        damageMultiplier: [3.68, 4.14, 4.6],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
            ...
            TECH: {
                ...
                skills: {
                    ...
                    omega_protocol: {
                        ...
                        energyCost: [86, 80, 74],
                        cooldown: 4,
                        damageMultiplier: [3.61, 4.06, 4.51],
                        damageType: 'TRUE',
                        targeting: 'AOE_LARGE',
            ...
            MUSIC: {
                ...
                skills: {
                    ...
                    lullaby: {
                        ...
                        cooldown: 3,
                        targeting: 'AOE_SMALL',
                        effects: { sleep: { chance: [60, 65, 70, 74, 79], duration: 2 } },
                    ...
                    crescendo: {
                        ...
                        energyCost: [62, 56, 51],
                        cooldown: 4,
                        damageMultiplier: [2.63, 3.01, 3.39],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
            ...
            BUSHIDO: {
                ...
                skills: {
                    ...
                    seven_cuts: {
                        ...
                        energyCost: [71, 65, 59],
                        cooldown: 4,
                        damageMultiplier: [5.06, 5.52, 5.98],
                        damageType: 'TRUE',
                        targeting: 'AOE_LARGE',
            ...
            IMMORTALITY: {
                ...
                skills: {
                    ...
                    eternal_slumber: {
                        ...
                        requiredLevel: 39,
                        maxLevel: 5,
                        energyCost: [64, 61, 57, 53, 49],
                        cooldown: 3,
                        targeting: 'AOE',
                        effects: {
                            sleep: { chance: [32, 45, 57, 69, 81], duration: 2 }
                        },
                    ...
                    apocalypse_nova: {
                        ...
                        requiredLevel: 40,
                        maxLevel: 3,
                        energyCost: [139, 121, 101],
                        cooldown: 4,
                        damageMultiplier: [3.4, 4.25, 5.1], // was [12.0, 16.0, 22.0] — nerfed AOE ult
                        damageType: 'MAGICAL',
                        targeting: 'ALL_ENEMIES',
                        effects: {
            ...
            MASTERY: {
                ...
                skills: {
                    ...
                    time_loop: {
                        ...
                        targeting: 'SINGLE',
                        effects: {
                            stun: { chance: [42, 50, 59, 67, 84], duration: 2 }
                        },
                    ...
                    paradox_wave: {
                        ...
                        requiredLevel: 40,
                        maxLevel: 3,
                        energyCost: [132, 121, 109],
                        cooldown: 4,
                        damageMultiplier: [3.49, 4.36, 5.23], // was [10.0, 14.0, 20.0] — nerfed AOE ult
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
            ...
            HOLINESS: {
                ...
                skills: {
                    ...
                    heavenly_wrath: {
                        ...
                        energyCost: [132, 121, 109],
                        cooldown: 4,
                        damageMultiplier: [8.72, 10.89, 13.07],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: {
                            stun: { chance: [40, 56, 72], duration: 1 }
                        },
            ...
            GUARDIAN: {
                ...
                skills: {
                    natures_wrath_asc: {
                        ...
                        energyCost: [33, 31, 28, 26, 24],
                        cooldown: 3,
                        damageMultiplier: [3.35, 3.83, 4.31, 4.79, 5.27],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                    ...
                    gais_judgment: {
                        ...
                        energyCost: [132, 121, 109],
                        cooldown: 4,
                        damageMultiplier: [3.05, 3.92, 4.79], // was [12.0, 15.0, 18.0] — nerfed AOE ult w/ root
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                        effects: {
                            root: { chance: [48, 64, 80], duration: 2 }
                        },
            ...
            WEALTH: {
                ...
                skills: {
                    ...
                    bribe: {
                        ...
                        requiredLevel: 34,
                        maxLevel: 5,
                        energyCost: [11, 11, 11, 11, 11],
                        goldCost: [1000, 2000, 3000, 4000, 5000],
                        cooldown: 3,
                        targeting: 'SINGLE',
                        effects: {
                            charm: { chance: [37, 47, 56, 70, 84], duration: 2 }
                        },
                    ...
                    zeni_storm: {
                        ...
                        cooldown: 4,
                        damageMultiplier: [3.61, 4.51, 5.41], // was [15.0, 25.0, 40.0] — nerfed TRUE dmg AOE ult
                        damageType: 'TRUE',
                        targeting: 'AOE_LARGE',
            ...
            ARCANE: {
                ...
                skills: {
                    ...
                    reality_warp: {
                        ...
                        targeting: 'AOE',
                        effects: {
                            confusion: { chance: [25, 34, 42, 50, 63], duration: 2 }
                        },
                    ...
                    singularity: {
                        ...
                        requiredLevel: 40,
                        maxLevel: 3,
                        energyCost: [132, 115, 96],
                        cooldown: 4,
                        damageMultiplier: [3.05, 3.49, 4.36], // was [20.0, 25.0, 30.0] — nerfed ALL_ENEMIES TRUE ult
                        damageType: 'MAGICAL',
                        targeting: 'ALL_ENEMIES',
            ...
            VOID: {
                ...
                skills: {
                    ...
                    essence_drain: {
                        ...
                        energyCost: [33, 31, 28, 26, 24],
                        cooldown: 3,
                        damageMultiplier: [1.92, 2.2, 2.49, 2.78, 3.06],
                        damageType: 'MAGICAL',
                        targeting: 'SINGLE',
                        effects: {
                    ...
                    abyssal_grasp: {
                        ...
                        targeting: 'SINGLE',
                        effects: {
                            root: { chance: [44, 57, 70, 88, 88], duration: 2 },
                    ...
                    entropy_wave: {
                        ...
                        requiredLevel: 39,
                        maxLevel: 5,
                        energyCost: [68, 64, 60, 57, 53],
                        cooldown: 3,
                        damageMultiplier: [2.52, 2.88, 3.24, 3.61, 4.06],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
                    ...
                    oblivion: {
                        ...
                        energyCost: [132, 121, 109],
                        cooldown: 4,
                        damageMultiplier: [4.36, 5.23, 6.1], // was [18.0, 22.0, 25.0] — nerfed ALL targets ult (stays higher, single-ish)
                        damageType: 'MAGICAL',
                        targeting: 'ALL',
            ...
            SHADOW: {
                ...
                skills: {
                    ...
                    eviscerate: {
                        ...
                        requiredLevel: 37,
                        maxLevel: 5,
                        energyCost: [38, 35, 32, 28, 25],
                        cooldown: 3,
                        damageMultiplier: [3.83, 4.31, 4.79, 5.27, 6.23],
                        damageType: 'PHYSICAL',
                        targeting: 'SINGLE',
                        effects: {
                    ...
                    eclipse: {
                        ...
                        requiredLevel: 40,
                        maxLevel: 3,
                        energyCost: [128, 115, 102],
                        cooldown: 4,
                        damageMultiplier: [10.63, 12.4, 14.17],
                        damageType: 'TRUE',
                        targeting: 'ALL_ENEMIES',
            ...
            ZEN: {
                ...
                skills: {
                    ...
                    serene_impact: {
                        ...
                        targeting: 'AOE',
                        effects: {
                            stun: { chance: [28, 42, 56, 70, 84], duration: 1 }
                        },
                    ...
                    one_with_universe: {
                        ...
                        energyCost: [0, 0, 0],
                        cooldown: 4,
                        damageMultiplier: [5.23, 6.1, 6.97], // was [15.0, 18.0, 20.0] — nerfed TRUE ALL ult
                        damageType: 'TRUE',
                        targeting: 'ALL',
            ...
            DRACO: {
                ...
                skills: {
                    ...
                    apocalypse_wing: {
                        ...
                        requiredLevel: 80,
                        maxLevel: 3,
                        energyCost: [148, 135, 123],
                        cooldown: 4,
                        damageMultiplier: [8.11, 9.01, 9.91],
                        damageType: 'MAGICAL',
                        targeting: 'AOE_ALL',
                        isUltimate: true,
                        isAscended: true,
            ...
            DOMINION: {
                ...
                skills: {
                    ...
                    flight_of_the_wyrms: {
                        ...
                        requiredLevel: 80,
                        maxLevel: 3,
                        energyCost: [135, 123, 111],
                        cooldown: 4,
                        damageMultiplier: [7.66, 8.56, 9.46],
                        damageType: 'PHYSICAL',
                        targeting: 'AOE_ALL',
                        isUltimate: true,
                        isAscended: true,
            ...
            WAR: {
                ...
                skills: {
                    ...
                    empire_strike: {
                        ...
                        requiredLevel: 40,
                        maxLevel: 3,
                        energyCost: [128, 116, 105],
                        cooldown: 4,
                        damageMultiplier: [3.54, 4.43, 5.31], // was [12.0, 15.0, 18.0] — nerfed AOE physical ult
                        damageType: 'PHYSICAL',
                        targeting: 'AOE',
            ...
            SHADOW: {
                ...
                skills: {
                    ...
                    thousand_shadows: {
                        ...
                        energyCost: [132, 118, 105],
                        cooldown: 4,
                        damageMultiplier: [6.97, 8.72, 10.46],
                        damageType: 'PHYSICAL',
                        targeting: 'AOE',
            ...
            MUSIC: {
                ...
                skills: {
                    ...
                    serenade_of_peace: {
                        ...
                        targeting: 'AOE',
                        effects: {
                            sleep: { chance: [28, 42, 56, 70, 84], duration: 2 }
                        },
                    ...
                    crescendo: {
                        ...
                        energyCost: [55, 52, 48, 44, 41],
                        cooldown: 3,
                        damageMultiplier: [3.61, 4.06, 4.51, 4.96, 5.86],
                        damageType: 'MAGICAL',
                        targeting: 'SINGLE',
                        effects: {
            ...
            TECH: {
                ...
                skills: {
                    ...
                    automated_turret: {
                        ...
                        energyCost: [44, 41, 39, 37, 35],
                        cooldown: 3,
                        damageMultiplier: [1.44, 1.72, 2.01, 2.3, 2.68],
                        damageType: 'PHYSICAL',
                        targeting: 'AOE',
                    ...
                    orbital_strike: {
                        ...
                        energyCost: [139, 121, 101],
                        cooldown: 4,
                        damageMultiplier: [3.4, 4.25, 5.1], // was [20.0, 25.0, 35.0] — nerfed AOE large ult
                        damageType: 'MAGICAL',
                        targeting: 'AOE_LARGE',
            ...
            HARVEST: {
                ...
                skills: {
                    ...
                    grim_reaping: {
                        ...
                        energyCost: [38, 36, 34, 32, 29],
                        cooldown: 3,
                        damageMultiplier: [2.39, 2.68, 2.97, 3.26, 3.64],
                        damageType: 'PHYSICAL',
                        targeting: 'AOE',
            ...
            MARTIAL: {
                ...
                skills: {
                    ...
                    pressure_point: {
                        ...
                        targeting: 'SINGLE',
                        effects: {
                            stun: { chance: [28, 37, 47, 60, 74], duration: 1 }
                        },
