...
const EVOLVED_CLASSES = {
    ...
    WAREMPEROR: {
        ...
        passive: { name: 'Absolute Command', desc: `Party immune to debuffs; -25% incoming damage to party at all times` },
    },
    BERSERKER: {
        id: 'BERSERKER',
        name: 'Berserker',
    ...
    ANNIHILATOR: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Endless Wrath', desc: `Damage +3% per 1% HP missing + 20% lifesteal on all attacks` },
    },
    PALADIN: {
        id: 'PALADIN',
        name: 'Paladin',
    ...
    SERAPH: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Absolute Retribution', desc: `Reflect 40% damage received, immune to debuffs.` },
    },
    DRAGONSLAYER: {
        id: 'DRAGONSLAYER',
        name: 'Dragonslayer',
    ...
    ASTRALWYRM: {
        ...
        passive: { name: 'Astral Dominion', desc: `Immune to all status, -65% damage taken, reflect 15% as dragonfire.` },
    ...
    DRAGON_LORD: {
     ...
     BROOD_SOVEREIGN: {
        ...
        evolutionCost: 2000000,
        passive: { name: 'Supreme Wyrmguard', desc: `Immune to fear/stun/Silence, reflect 40% melee as fire, -50% dmg from non dragons.` },
         isSuccessor: true,
         succeeds: 'ASTRALWYRM',
    },
    ...
    NIGHTBLADE: {
     ...
     NEMESIS: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Flawless Mark', desc: `25% chance any attack deals 15x more dmg.` },
    },
    ...
    ZENMASTER: {
     ...
     BUUDHA: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Transcendence', desc: `Immune to stun/silence, all skills cost 0 EP.` },
    },
    ...
    TENNO: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Absolute Command', desc: `Party +35% physical dmg.` },
    },
    NINJA: {
        id: 'NINJA',
        name: 'Ninja',
    ...
    KAGE: {
     ...
     YAMI: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Complete Stealth', desc: `75% base evasion; first hit each combat is guaranteed instakill on non-boss enemies` },
    },
    ...
    ARCHMAGE: {
     ...
     DEMIURGE: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Ominiscience', desc: `Energy costs reduced to 0; +30% MAG.` },
    },
    ...
    VOIDWALKER: {
     ...
     VOIDLORD: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Total Darkness', desc: `-30% nearby enemy ATK/DEF; Immune to all CC.` },
    },
    ...
    AVATAR: {
     ...
     PRIMORDIAL: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Primordial Avatar', desc: `Immune to all elemental dmg; always crits enemy elemental weakness.` },
    },
    ...
    LICH: {
     ...
     NEKROS: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Undying Sovereign', desc: `Revives at full HP, twice per quest.` },
    },
    ...
    TIMELORD: {
     ...
     CHRONARCH: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Ruler of Time', desc: `Takes 3 actions per turn; skills have no cooldown.` },
    },
    ...
    SAINT: {
     ...
     EMPYREAN: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Pure Grace', desc: `Healing tripled; Party immune to death once per battle.` },
    },
    DRUID: {
        id: 'DRUID',
        name: 'Druid',
    ...
    ARCHDRUID: {
     ...
     SYLVANUS: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Worlds Will', desc: `Self regen 6% HP/turn; party regen 3% HP/turn.` },
    },
    ...
    TYCOON: {
     ...
     PLUTOCRAT: {
        ...
        passive: { name: 'MIDAS TOUCH', desc: `Gold never decreases; +100% zeni earned.` },
    },
    ...
    VIRTUOSO: {
     ...
     HARMONIA: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Eternal Muse', desc: `Revives one fallen ally each turn automatically; party immune to silence.` },
    },
    ...
    GRAND_INVENTOR: {
     ...
     TECHNARCH: {
        ...
        evolutionCost: 1000000,
        passive: { name: 'Omega Craftsman', desc: `Triple crafting output; summons deal +80% dmg` },
    },
};
