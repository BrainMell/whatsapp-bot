...
**Skill Points Calculation** — [`skillTree.js` L4738–4747](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/rpg/skillTree.js#L4738-L4747)

```javascript
// core/rpg/skillTree.js L4738–4747
...
**Evolution Check and Class Change** — [`skillCommands.js` L485–508](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/commands/skillCommands.js#L485-L508)

```javascript
// core/commands/skillCommands.js L485–508
...
**Skill Upgrade Process** — [`skillCommands.js` L120–140](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/commands/skillCommands.js#L120-L140)

```javascript
// core/commands/skillCommands.js L120–140
...
To change how many skill points are gained per level or milestone, modify `calculateSkillPoints` at [skillTree.js L4738](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/rpg/skillTree.js#L4738):
...
To add an item check (e.g. requiring a specific dungeon fragment) for class evolutions, edit `canEvolve` inside `core/rpg/classSystem.js`.

---

## Common tasks

- **Adjust evolution requirements (level, stone, gold)** — Edit the evolution descriptors within `core/rpg/classSystem.js`.
- **Change how many skill points are gained per level** — Modify `calculateSkillPoints` at [skillTree.js L4738](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/rpg/skillTree.js#L4738).
- **Add a new skill node to a class tree** — Edit the `SKILL_TREES` definitions for the class inside [skillTree.js L10–250](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/rpg/skillTree.js#L10).
- **Edit the message displayed when evolving** — Edit `handleEvolve` inside [skillCommands.js L516](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/commands/skillCommands.js#L516).
- **Upgrade costs scaling** — Change `getSkillCost` at [skillTree.js L4749](file:///home/mellow/Desktop/Joker/whatsapp-bot/core/rpg/skillTree.js#L4749).
