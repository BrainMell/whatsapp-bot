...
const COMMAND_REGISTRY = {
  ...
  ADMIN: [
    ...
    { cmd: 'antibot', desc: 'Detect other bots posting in the group and act on them.', usage: 'antibot on/off/action/mode' },
    { cmd: 'gstatus', desc: "Post to this group's status or toggle status announcements.", usage: "gstatus <text> | gstatus (reply media) | gstatus on/off" },
    { cmd: 'announce', desc: 'Toggle admin promote/demote announcements.', usage: 'announce on/off' },
    ...
    { cmd: 'glock', desc: 'Lock the group (Admins-only or Rank-locked with "glock rank <level>").', usage: 'glock OR glock rank <level> OR glock open' },
    { cmd: 'gunlock', desc: 'Unlock the group, allowing everyone to send messages.', usage: 'gunlock OR open' },
    { cmd: 'rank setup', desc: 'Initialize default rank ladder (Overlord to Wanderer).', usage: 'rank setup' },
    { cmd: 'rank add', desc: 'Add a custom rank level, icon and name.', usage: 'rank add <level> <icon> <name>' },
    { cmd: 'rank remove', desc: 'Remove a rank level from the ladder.', usage: 'rank remove <level>' },
    { cmd: 'ranks', desc: 'View the group rank ladder configuration.', usage: 'ranks' },
    { cmd: 'set rank', desc: 'Assign a custom rank to a group member.', usage: 'set rank @user <level>' },
  ...
  RPG: [
    ...
    { cmd: 'kills', desc: 'The Fortune Teller’s reading: souls you sent beyond the veil. First sight needs level 40, abyss floor 31, and the reader’s fee.', usage: 'kills | kills pay' },
    { cmd: 'combat', desc: 'Combat actions for an active battle: attack, abilities, items, defend, rest.', usage: 'combat <atk/skill/item/def/rest> [n]' },
    { cmd: 'world', desc: 'The living charts: cosmology atlas and the four realms with their gates.', usage: 'world [all|beyond|afterlife|abyss]' },
    { cmd: 'evolve', desc: 'Evolve your class when you meet the requirements.', usage: 'evolve' },
    { cmd: 'trial', desc: 'View and start ascension trials for your class.', usage: 'trial [start]' },
    { cmd: 'use', desc: 'Use a consumable from your inventory.', usage: 'use <id/#>' },
    ...
    { cmd: 'blacksmith', desc: 'Access the blacksmith to repair your equipment or check condition costs.', usage: 'blacksmith' },
    { cmd: 'repair', desc: 'Repair an equipped item using Zeni.', usage: 'repair <slot/index/all>' },
    { cmd: 'inspect', desc: 'Inspect an equipped item to view detailed stats and durability.', usage: 'inspect <slot>' },
    ...
    { cmd: 'abyss resume', desc: 'Restart combat after bot restart.', usage: 'abyss resume' },
    ...
    { cmd: 'hospital', desc: 'Full heal at the hospital (12h cooldown).', usage: 'hospital' },
    { cmd: 'heal', desc: 'Alias for hospital.', usage: 'heal' },
    { cmd: 'clinic', desc: 'Alias for hospital.', usage: 'clinic' },
    ...
    { cmd: 'summon info', desc: 'Detailed summon view.', usage: 'summon info <id>' },
    { cmd: 'summon train', desc: 'Daily training (+500 XP).', usage: 'summon train <id>' },
    { cmd: 'summon allocate', desc: 'Allocate stat points.', usage: 'summon allocate <id> <stat> <pts>' },
    { cmd: 'summon hatch', desc: 'Hatch a summon egg.', usage: 'summon hatch <egg_id>' },
    { cmd: 'summon eggcraft', desc: 'Craft eggs from fragments.', usage: 'summon eggcraft <rare|epic|legendary|mythic>' },
    { cmd: 'summon skill', desc: 'View/manage summon skill tree.', usage: 'summon skill <id>' },
    { cmd: 'summon skill choose', desc: 'Choose a skill path (A/B/C).', usage: 'summon skill choose <id> <A|B|C>' },
    { cmd: 'summon skill unlock', desc: 'Unlock a skill node.', usage: 'summon skill unlock <id> <A1-A5>' },
    { cmd: 'summon skill respec', desc: 'Reset skill tree (needs scroll).', usage: 'summon skill respec <id>' },
    { cmd: 'summon evolve', desc: 'Evolve a summon to its next form.', usage: 'summon evolve <id>' },
    { cmd: 'summon bond', desc: 'View bond level + bonuses.', usage: 'summon bond <id>' },
    { cmd: 'summon traits', desc: 'View summon traits.', usage: 'summon traits <id>' },
    { cmd: 'summon ai', desc: 'View/set AI behavior mode.', usage: 'summon ai <id> [mode]' },
    { cmd: 'summon equip', desc: 'Equip summon gear.', usage: 'summon equip <summonId> <gearId>' },
    { cmd: 'summon unequip', desc: 'Unequip summon gear.', usage: 'summon unequip <summonId> <slot>' },
    { cmd: 'summon resonance', desc: 'View resonance bonuses.', usage: 'summon resonance' },
    { cmd: 'summon codex', desc: 'View ALL summon species.', usage: 'summon codex' },
    { cmd: 'summon forge', desc: 'Soul Forge two summons.', usage: 'summon forge <id1> <id2>' },
    { cmd: 'summon market', desc: 'Summon trading market.', usage: 'summon market <list/sell/buy/cancel>' }
  ],
  GROUP: [
  ...
  CARDS: [
    ...
    { cmd: 'coll', desc: 'View collection. Use .coll <id> for details.', usage: 'coll [id/#]' },
    ...
    { cmd: 'lock', desc: 'Protect a card from being sold or merged.', usage: 'lock <slot/id>' },
    { cmd: 'mergeall', desc: 'Instantly merge all duplicates in your bag.', usage: 'mergeall' },
    ...
    { cmd: 'burn', desc: 'Permanently delete a card from your collection.', usage: 'burn <coll#>' },
    { cmd: 'accept', desc: 'Confirm a pending action (like burning a card).', usage: 'accept' },
  ...
  FUN: [
    ...
    { cmd: 'clip', desc: 'Cut & cite a section of an audio/voice note (reply to it).', usage: 'clip <start> <end>' },
    { cmd: 'trivia', desc: 'Play a trivia quiz game.', usage: 'trivia' },
    { cmd: 'qr', desc: 'Generate a QR code image from text or URL.', usage: 'qr <text>' },
    { cmd: 'short', desc: 'Shorten any long URL.', usage: 'short <url>' },
    { cmd: 'git', desc: 'Search GitHub user profile stats.', usage: 'git <username>' },
    { cmd: 'animequote', desc: 'Get a random iconic anime quote.', usage: 'animequote' },
    { cmd: 'cat', desc: 'Get a random cute cat picture.', usage: 'cat' },
    { cmd: 'dog', desc: 'Get a random cute dog picture.', usage: 'dog' },
    { cmd: 'waifu', desc: 'Get a random beautiful waifu image.', usage: 'waifu' },
  ...
  GAMES: [
    ...
    { cmd: 'ludo end', desc: 'Quit an active Ludo game (counts as a forfeit).', usage: 'ludo end' },
    { cmd: 'ludo leave', desc: 'Forfeit your Ludo seat (game continues if 2+ players remain).', usage: 'ludo leave' },
