...
const EVOLVED_CLASSES = {
    ...
    BERSERKER: {
        ...
        evolvedFrom: 'FIGHTER',
        role: 'TANK',
        stats: { hp: 220, atk: 20, def: 10, mag: 1, spd: 8, luck: 4, crit: 14 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    DOOMSLAYER: {
        ...
        role: 'TANK',
        stats: { hp: 560, atk: 52, def: 22, mag: 2, spd: 18, luck: 5, crit: 28 },
    ...
    PALADIN: {
        ...
        evolvedFrom: 'FIGHTER',
        role: 'TANK',
        stats: { hp: 180, atk: 10, def: 22, mag: 10, spd: 5, luck: 8, crit: 4 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    DRAGON_GOD: {
        ...
        role: 'TANK',
        stats: { hp: 500, atk: 40, def: 42, mag: 25, spd: 15, luck: 18, crit: 18 },
    ...
    ROGUE: {
        ...
        evolvedFrom: 'SCOUT',
        role: 'DPS',
        stats: { hp: 105, atk: 20, def: 5, mag: 3, spd: 22, luck: 18, crit: 28 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    NIGHTBLADE: {
        ...
        evolvedFrom: 'ROGUE',
        role: 'DPS',
        stats: { hp: 260, atk: 45, def: 12, mag: 12, spd: 50, luck: 35, crit: 45 },
    ...
    MONK: {
        ...
        evolvedFrom: 'SCOUT',
        role: 'DPS',
        stats: { hp: 125, atk: 16, def: 10, mag: 7, spd: 20, luck: 12, crit: 18 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    ZENMASTER: {
        ...
        evolvedFrom: 'MONK',
        role: 'DPS',
        stats: { hp: 340, atk: 38, def: 22, mag: 32, spd: 45, luck: 22, crit: 28 },
    ...
    SAMURAI: {
        ...
        evolvedFrom: 'SCOUT',
        role: 'DPS',
        stats: { hp: 135, atk: 18, def: 10, mag: 5, spd: 18, luck: 12, crit: 22 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    SHOGUN: {
        ...
        evolvedFrom: 'SAMURAI',
        role: 'DPS',
        stats: { hp: 330, atk: 50, def: 28, mag: 12, spd: 25, luck: 18, crit: 35 },
    ...
    NINJA: {
        ...
        evolvedFrom: 'SCOUT',
        role: 'DPS',
        stats: { hp: 98, atk: 18, def: 5, mag: 6, spd: 26, luck: 18, crit: 30 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    KAGE: {
        ...
        evolvedFrom: 'NINJA',
        role: 'DPS',
        stats: { hp: 235, atk: 55, def: 14, mag: 18, spd: 58, luck: 30, crit: 50 },
    ...
    WARLOCK: {
        ...
        evolvedFrom: 'APPRENTICE',
        role: 'MAGIC_DPS',
        stats: { hp: 100, atk: 7, def: 6, mag: 28, spd: 8, luck: 8, crit: 12 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    VOIDWALKER: {
        ...
        evolvedFrom: 'WARLOCK',
        role: 'MAGIC_DPS',
        stats: { hp: 280, atk: 18, def: 24, mag: 65, spd: 18, luck: 12, crit: 18 },
    ...
    ELEMENTALIST: {
        ...
        evolvedFrom: 'APPRENTICE',
        role: 'MAGIC_DPS',
        stats: { hp: 92, atk: 7, def: 6, mag: 32, spd: 10, luck: 10, crit: 13 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    AVATAR: {
        ...
        role: 'MAGIC_DPS',
        stats: { hp: 230, atk: 18, def: 22, mag: 78, spd: 28, luck: 22, crit: 25 },
    ...
    NECROMANCER: {
        ...
        evolvedFrom: 'APPRENTICE',
        role: 'MAGIC_DPS',
        stats: { hp: 95, atk: 6, def: 5, mag: 28, spd: 8, luck: 8, crit: 11 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    LICH: {
        ...
        role: 'MAGIC_DPS',
        stats: { hp: 290, atk: 14, def: 24, mag: 72, spd: 20, luck: 18, crit: 20 },
    ...
    CHRONOMANCER: {
        ...
        evolvedFrom: 'APPRENTICE',
        role: 'MAGIC_DPS',
        stats: { hp: 88, atk: 6, def: 5, mag: 30, spd: 16, luck: 12, crit: 12 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    TIMELORD: {
        ...
        role: 'MAGIC_DPS',
        stats: { hp: 215, atk: 14, def: 20, mag: 75, spd: 60, luck: 28, crit: 22 },
    ...
    REAPER: {
        ...
        evolvedFrom: 'APPRENTICE',
        role: 'DPS',
        stats: { hp: 165, atk: 38, def: 12, mag: 32, spd: 16, luck: 12, crit: 28 },
    ...
    DEATH_LORD: {
        ...
        evolvedFrom: 'REAPER',
        role: 'DPS',
        stats: { hp: 400, atk: 72, def: 22, mag: 55, spd: 32, luck: 18, crit: 38 },
    ...
    CLERIC: {
        ...
        evolvedFrom: 'ACOLYTE',
        role: 'SUPPORT',
        stats: { hp: 115, atk: 7, def: 10, mag: 24, spd: 10, luck: 15, crit: 8 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    SAINT: {
        ...
        evolvedFrom: 'CLERIC',
        role: 'SUPPORT',
        stats: { hp: 320, atk: 20, def: 40, mag: 62, spd: 22, luck: 35, crit: 18 },
    ...
    DRUID: {
        ...
        evolvedFrom: 'ACOLYTE',
        role: 'SUPPORT',
        stats: { hp: 120, atk: 9, def: 12, mag: 22, spd: 12, luck: 14, crit: 10 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    ARCHDRUID: {
        ...
        evolvedFrom: 'DRUID',
        role: 'SUPPORT',
        stats: { hp: 360, atk: 25, def: 38, mag: 58, spd: 26, luck: 28, crit: 20 },
    ...
    MERCHANT: {
        ...
        evolvedFrom: 'ACOLYTE',
        role: 'SUPPORT',
        stats: { hp: 110, atk: 7, def: 9, mag: 14, spd: 11, luck: 28, crit: 10 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    TYCOON: {
        ...
        role: 'SUPPORT',
        stats: { hp: 280, atk: 22, def: 30, mag: 40, spd: 25, luck: 90, crit: 28 },
    ...
    BARD: {
        ...
        evolvedFrom: 'ACOLYTE',
        role: 'SUPPORT',
        stats: { hp: 105, atk: 8, def: 8, mag: 20, spd: 14, luck: 16, crit: 12 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    VIRTUOSO: {
        ...
        evolvedFrom: 'BARD',
        role: 'SUPPORT',
        stats: { hp: 260, atk: 18, def: 18, mag: 48, spd: 28, luck: 35, crit: 22 },
    ...
    ARTIFICER: {
        ...
        evolvedFrom: 'ACOLYTE',
        role: 'SUPPORT',
        stats: { hp: 112, atk: 10, def: 10, mag: 18, spd: 12, luck: 12, crit: 13 },
        requirement: { level: 20, questsCompleted: 20, gold: 15000 },
        evolutionCost: 15000,
    ...
    GRAND_INVENTOR: {
        ...
        role: 'SUPPORT',
        stats: { hp: 290, atk: 22, def: 30, mag: 36, spd: 20, luck: 24, crit: 18 },
    ...
    GOD_HAND: {
        ...
        evolvedFrom: 'ACOLYTE',
        role: 'DPS',
        stats: { hp: 200, atk: 42, def: 22, mag: 22, spd: 32, luck: 16, crit: 18 },
        requirement: { level: 35, questsCompleted: 30, gold: 20000 },
        evolutionCost: 20000,
    ...
    DIVINE_FIST: {
        ...
        role: 'DPS',
        stats: { hp: 460, atk: 80, def: 35, mag: 28, spd: 50, luck: 22, crit: 28 },
...
const ADVENTURER_RANKS = {
    F: {
        ...
        lore: 'Fresh off the street. No record. No reputation. Pure potential.'
    },
    E: {
        name: 'E-Rank', icon: '🥉', color: '🟤',
        requirement: { level: 10, questsCompleted: 10 },
        benefits: { questRewardBonus: 5 },
        lore: 'Survived enough jobs to prove they\'re serious. The guild is starting to take notice.'
    },
    D: {
        name: 'D-Rank', icon: '🥈', color: '⚪',
        requirement: { level: 20, questsCompleted: 25 },
        benefits: { questRewardBonus: 10 },
        lore: 'A reliable hired sword. Merchants specifically request D-Ranks for escort jobs.'
    },
    C: {
        name: 'C-Rank', icon: '🥇', color: '🟡',
        requirement: { level: 30, questsCompleted: 50 },
        benefits: { questRewardBonus: 15 },
        lore: 'Recognized across most regions. Can access restricted dungeon wings.'
    },
    B: {
        name: 'B-Rank', icon: '💎', color: '🔵',
        requirement: { level: 40, questsCompleted: 80 },
        benefits: { questRewardBonus: 20 },
        lore: 'Veterans. The guild sends them when things go wrong and need fixing quickly.'
    },
    A: {
        name: 'A-Rank', icon: '💠', color: '🟢',
        requirement: { level: 50, questsCompleted: 120 },
        benefits: { questRewardBonus: 30 },
        lore: 'Elite. Capable of solo-clearing dungeons that require parties at lower ranks.'
    },
    S: {
        name: 'S-Rank', icon: '⭐', color: '🟣',
        requirement: { level: 60, questsCompleted: 180 },
        benefits: { questRewardBonus: 40 },
        lore: 'Legendary. Countries hire S-Ranks for threats they cannot handle with armies.'
    },
    SS: {
        name: 'SS-Rank', icon: '🌟', color: '🔴',
        requirement: { level: 75, questsCompleted: 250 },
        benefits: { questRewardBonus: 60 },
        lore: 'Walking disasters. Their names make monsters reconsider their life choices.'
    },
    SSS: {
        name: 'SSS-Rank', icon: '✨', color: '🌈',
        requirement: { level: 90, questsCompleted: 500 },
        benefits: { questRewardBonus: 100 },
        lore: 'Beyond classification. The guild stopped trying to assign them jobs — they just show up where needed.'
    },
};

// ==========================================
// 🛒 SHOP ITEMS (unchanged from original)
// ==========================================
...
const CLASS_SHOP_ITEMS = {
    ...
    evolution_stone: {
        ...
        requirement: 'Must be a Starter class at level 10+'
    },
    ascension_stone: {
        ...
        requirement: 'Must be an Evolved class at level 30+'
    },
    dragon_key: {
        id: 'dragon_key', name: 'Dragon Hunter Key', icon: '🔑🐲',
        desc: 'Unlocks the Dragon\'s Lair dungeon. Required for Dragonslayer evolution.',
        cost: 15000, type: 'SPECIAL_KEY', category: 'CLASS',
        requirement: 'Must be level 15+'
    },
    dragon_seal_ring: {
        id: 'dragon_seal_ring', name: 'Dragon Seal Ring', icon: '💍🐲',
        desc: 'Ancient ring that allows your attacks to pierce dragon scales.',
        cost: 20000, type: 'EQUIPMENT', category: 'CLASS',
        requirement: 'Must be level 40+', slot: 'ring', stats: { atk: 5 }
    },
    stat_manual: {
        id: 'stat_manual', name: 'Ancient Stat Manual', icon: '📜',
        desc: 'Permanently boosts ALL base stats by 5.',
        cost: 100000, type: 'STAT_BOOST_PERM', category: 'PERMANENT', rarity: 'EPIC'
    },
    skill_reset: {
    ...
    health_potion_shop: {
        id: 'health_potion_shop', name: 'Health Potion', icon: '🧪',
        desc: 'Restore 35% of Max HP during a quest.', cost: 700, type: 'CONSUMABLE', category: 'QUEST'
    },
    phoenix_down_shop: {
        id: 'phoenix_down_shop', name: 'Phoenix Down', icon: '🪶',
        desc: 'Auto-revive at 50% HP when defeated (quest only).', cost: 3500, type: 'CONSUMABLE', category: 'QUEST'
    },
    strength_brew_shop: {
        id: 'strength_brew_shop', name: 'Strength Brew', icon: '💪',
        desc: '+25% ATK for 3 turns.', cost: 800, type: 'CONSUMABLE', category: 'QUEST'
    },
    lucky_charm_shop: {
        id: 'lucky_charm_shop', name: 'Lucky Charm', icon: '🍀',
        desc: '+40% LUCK for 3 turns.', cost: 1000, type: 'CONSUMABLE', category: 'QUEST'
    },
    hp_supplement: {
        id: 'hp_supplement', name: 'HP Supplement', icon: '❤️',
        desc: 'Permanently increase max HP by 10.', cost: 3000, type: 'STAT_BOOST', category: 'PERMANENT',
        boost: { stat: 'hp', value: 10 }
    },
    attack_manual: {
        id: 'attack_manual', name: 'Attack Manual', icon: '⚔️',
        desc: 'Permanently increase ATK by 2.', cost: 2400, type: 'STAT_BOOST', category: 'PERMANENT',
        boost: { stat: 'atk', value: 2 }
    },
    defense_guide: {
        id: 'defense_guide', name: 'Defense Guide', icon: '🛡️',
        desc: 'Permanently increase DEF by 2.', cost: 2400, type: 'STAT_BOOST', category: 'PERMANENT',
        boost: { stat: 'def', value: 2 }
    },
    magic_tome: {
        id: 'magic_tome', name: 'Magic Tome', icon: '📚',
        desc: 'Permanently increase MAG by 2.', cost: 2400, type: 'STAT_BOOST', category: 'PERMANENT',
        boost: { stat: 'mag', value: 2 }
    },
    speed_boots: {
        id: 'speed_boots', name: 'Speed Boots', icon: '👟',
        desc: 'Permanently increase SPD by 2.', cost: 2000, type: 'STAT_BOOST', category: 'PERMANENT',
        boost: { stat: 'spd', value: 2 }
    },
    fortune_cookie: {
        id: 'fortune_cookie', name: 'Fortune Cookie', icon: '🥠',
        desc: 'Permanently increase LUCK by 2.', cost: 1500, type: 'STAT_BOOST', category: 'PERMANENT',
        boost: { stat: 'luck', value: 2 }
    },
    rusty_dagger: {
        id: 'rusty_dagger', name: 'Rusted Dagger', icon: '🗡️',
        desc: 'A simple blade. (+5 ATK)', cost: 1000, type: 'EQUIPMENT', category: 'EQUIPMENT',
        rarity: 'COMMON', stats: { atk: 5 }, slot: 'weapon'
    },
    iron_sword: {
        id: 'iron_sword', name: 'Iron Sword', icon: '⚔️',
        desc: 'A sturdy iron blade. (+12 ATK)', cost: 5000, type: 'EQUIPMENT', category: 'EQUIPMENT',
        rarity: 'UNCOMMON', stats: { atk: 12 }, slot: 'weapon'
    },
    arcane_wand: {
        id: 'arcane_wand', name: 'Arcane Wand', icon: '🪄',
        desc: 'Focuses arcane energy into lethal beams. (+18 MAG)', cost: 6000, type: 'EQUIPMENT', category: 'EQUIPMENT',
        rarity: 'RARE', stats: { mag: 18 }, slot: 'weapon'
    },
    leather_tunic: {
        id: 'leather_tunic', name: 'Leather Tunic', icon: '🧥',
        desc: 'Basic protection. (+8 DEF)', cost: 1600, type: 'EQUIPMENT', category: 'EQUIPMENT',
        rarity: 'COMMON', stats: { def: 8 }, slot: 'armor'
    },
    plate_armor: {
        id: 'plate_armor', name: 'Plate Armor', icon: '🛡️',
        desc: 'Heavy iron plating. (+25 DEF, +20 HP)', cost: 12000, type: 'EQUIPMENT', category: 'EQUIPMENT',
        rarity: 'RARE', stats: { def: 25, hp: 20 }, slot: 'armor'
    },
    essence_mirror: {
        id: 'essence_mirror', name: 'Essence Mirror', icon: '🪞',
        desc: 'Mirror the skills of any class outside your lineage (up to 3 skills).',
        cost: 100000, type: 'MISC', category: 'MISC', rarity: 'LEGENDARY'
    },
    xp_booster: {
        id: 'xp_booster', name: 'XP Booster', icon: '⭐',
        desc: 'Double XP earned from your next quest.', cost: 1000, type: 'BOOSTER', category: 'MISC'
    },
    gold_multiplier: {
        id: 'gold_multiplier', name: 'Gold Multiplier', icon: '💰',
        desc: 'Double gold earned from your next quest.', cost: 800, type: 'BOOSTER', category: 'MISC'
    },
    rare_loot_charm: {
        id: 'rare_loot_charm', name: 'Rare Loot Charm', icon: '🎁',
        desc: '+30% rare item drop chance for next quest.', cost: 2000, type: 'BOOSTER', category: 'MISC'
    },
};
...
function getClassById(classId) {
    ...
    return allClasses[classId.toUpperCase()] || null;
}

function getRandomStarterClass() {
    const starterKeys = Object.keys(STARTER_CLASSES);
    return STARTER_CLASSES[starterKeys[Math.floor(Math.random() * starterKeys.length)]];
}

function isFighterLineage(classId) {
    if (!classId) return false;
    let current = getClassById(classId);
    while (current) {
        if (current.id === 'FIGHTER') return true;
        if (!current.evolvedFrom) break;
...
function canEvolve(currentClassId, userLevel, questsCompleted, dragonsKilled = 0) {
    ...
    if (currentClass.tier === 'ASCENDED') return { canEvolve: false, reason: 'Already at maximum tier.' };
    
    const evolutionIds = currentClass.evolves_into;
    if (!evolutionIds?.length) return { canEvolve: false, reason: 'No evolutions available for this class.' };
    ...
    for (const evoId of evolutionIds) {
        ...
        if (dragonsKilled < (req.dragonsKilled || 0)) missing.push(`${req.dragonsKilled} Dragons Slain`);
        if (req.fighterBase && !isFighterLineage(currentClassId)) missing.push('Fighter Lineage Required');
...
function calculateAdventurerRank(level, questsCompleted) {
...
function getNextRankRequirements(currentRank) {
    ...
    return { rank: next, requirements: ADVENTURER_RANKS[next].requirement, benefits: ADVENTURER_RANKS[next].benefits };
}
