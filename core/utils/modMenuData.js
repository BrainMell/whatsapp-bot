...
const MOD_MENU = {
  ...
  CARDS: {
    ...
    commands: [
      ...
      { cmd: "cardmod", usage: "cardmod add/del/list @user", desc: "Manage card mods (owner/global mod)." },
    ],
  },
  ...
  MANAGEMENT: {
    ...
    tier: "gmod",
    commands: [
      { cmd: "addmod", usage: "addmod @user", desc: "Add a Global Moderator (owner only)." },
      { cmd: "delmod", usage: "delmod @user", desc: "Remove a Global Moderator (owner/gmod)." },
      { cmd: "addrpgmod", usage: "addrpgmod @user", desc: "Add an RPG Moderator (owner/gmod)." },
      ...
      { cmd: "reloadmods", usage: "reloadmods", desc: "Re-sync mod sets from DB (after external edits)." },
