...
const COMMAND_REGISTRY = {
  ...
  ECONOMY: [
    ...
    { cmd: 'history', desc: 'View the interaction history between two people.', usage: 'history @u1 [@u2]' },
    { cmd: 'bond', desc: 'Interaction bond between two people (same as history).', usage: 'bond @u1 [@u2]' },
