...
const COMMAND_REGISTRY = {
  ...
  ADMIN: [
    ...
    { cmd: 'antilink', desc: 'Enable/disable automatic deletion of links.', usage: 'antilink on/off' },
    { cmd: 'antispam', desc: 'Enable/disable anti-spam protection.', usage: 'antispam on/off' },
    { cmd: 'welcome', desc: 'Enable/disable welcome messages for new members.', usage: 'welcome on/off' },
    { cmd: 'welcomemsg', desc: 'Set a custom welcome message for the group.', usage: 'welcomemsg <text>' },
    { cmd: 'warn', desc: 'Give a warning to a member. 3 warnings = Kick.', usage: 'warn @user' },
  ...
  GUILDS: [
    ...
    { cmd: 'guild join', desc: 'Join an existing guild.', usage: 'guild join <name>' },
    ...
    { cmd: 'guild accept', desc: 'Accept a pending guild invitation.', usage: 'guild accept' },
    { cmd: 'guild decline', desc: 'Decline a pending guild invitation.', usage: 'guild decline' },
